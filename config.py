...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002414583408"))
...
#Database 
#Database [https://youtu.be/qFB0cFqiyOM?si=fVicsCc
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://Dost:Ak997110@cluster0.9qw9v.mongodb.net/?retryWrites=true&w=majority")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001928037346"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6057768840 5295407868").split()):
        ADMINS.append(int(x))
except ValueError:
